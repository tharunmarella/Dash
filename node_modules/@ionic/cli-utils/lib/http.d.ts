...
import { APIResponse, APIResponseError, APIResponseSuccess, CreateRequestOptions, HttpMethod, IClient, IConfig, IPaginator, Response, SuperAgentError } from '../definitions';
...
export declare function createRequest(method: string, url: string, opts?: CreateRequestOptions): Promise<{
    req: superagentType.SuperAgentRequest;
}>;
export declare function download(url: string, ws: NodeJS.WritableStream, opts?: {
    progress?: (loaded: number, total: number) => void;
} & CreateRequestOptions): Promise<void>;
