...
export declare function getSuitableNetworkInterfaces(): NetworkInterface[];
...
export declare function isHostConnectable(host: string, port: number, timeout?: number): Promise<boolean>;
